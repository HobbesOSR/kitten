...
#include <lwk/sched.h>
//#include <lwk/mm.h>
//#include <lwk/dma-mapping.h>
///#include <lwk/kvm_host.h>
...
int main(void)
{
  ...
  DEFINE(TI_FLAGS,		offsetof(struct task_struct, arch.flags));
  //DEFINE(tsk_arch_ ## entry, offsetof(struct task_struct, arch) + offsetof(struct arch_task, entry))
  // ENTRY(flags);
