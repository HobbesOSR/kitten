...
#define GICR_PIDR4_OFFSET            (0xffd0)
#define GICR_PIDR5_OFFSET            (0xffd4)
#define GICR_PIDR6_OFFSET            (0xffd8)
#define GICR_PIDR7_OFFSET            (0xffdc)
#define GICR_PIDR0_OFFSET            (0xffe0)
#define GICR_PIDR1_OFFSET            (0xffe4)
#define GICR_PIDR2_OFFSET            (0xffe8)
#define GICR_PIDR3_OFFSET            (0xffec)
#define GICR_CIDR0_OFFSET            (0xfff0)
#define GICR_CIDR1_OFFSET            (0xfff4)
#define GICR_CIDR2_OFFSET            (0xfff8)
#define GICR_CIDR3_OFFSET            (0xfffc)
