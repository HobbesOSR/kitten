 ...
 */
#define VMALLOC_START		_UL(0xffffff8000000000)
#define VMALLOC_END		(PAGE_OFFSET - _UL(0x400000000) - SZ_64K)
...
#define _UL(x) _AC(x, UL) // TODO: Unsure why the header files are not including this?
