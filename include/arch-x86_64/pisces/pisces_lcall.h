...
#define PISCES_LCALL_IOMMU_ATTACH	(KERN_LCALL_START + 102)
#define PISCES_LCALL_IOMMU_DETACH	(KERN_LCALL_START + 103)
#define PISCES_LCALL_IOMMU_MAP		(KERN_LCALL_START + 104)
#define PISCES_LCALL_IOMMU_UNMAP	(KERN_LCALL_START + 105)
#define PISCES_LCALL_IOMMU_ALLOC_DOMAIN (KERN_LCALL_START + 106)
#define PISCES_LCALL_IOMMU_FREE_DOMAIN	(KERN_LCALL_START + 107)

#define PISCES_LCALL_PCI_ATTACH      PISCES_LCALL_IOMMU_ATTACH
#define PISCES_LCALL_PCI_DETACH      PISCES_LCALL_IOMMU_DETACH
